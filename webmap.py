# 1. create a feature group then add points to it over the Map
# 2. any details check documentation and argument list of
# here everything revolves around a map object
import folium
import pandas as pd
